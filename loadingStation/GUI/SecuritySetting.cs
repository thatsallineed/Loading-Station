...
namespace loadingStation.GUI
{
    public partial class SecuritySetting : Form
    {
        ...
        private void LoadDgv()
        {
            ...
            {
                Core.Log.Error.Collect(x.ToString());
            }
        }
        ...
        private void BtnRestart_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.OK)
            {
                ...
                Core.Function.GlobalProperties.FLAG_LOGGING = false;

                foreach (Core.Modbus.ModbusOutput sd in GlobalProperties.DevicesOutput)
                {
                    sd.ResetAllBit();
                }
                ...
                foreach (Core.Modbus.ModbusInput sd in GlobalProperties.DevicesInput)
                {
                    sd.StopLogging();
                }
